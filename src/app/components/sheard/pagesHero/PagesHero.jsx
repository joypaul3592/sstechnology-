...
import element3 from '../../../assets/image/elements/blueElementStroke.png'
...
export default function PagesHero({ title, text }) {
    return (
        <div className="sm:pt-10 pt-5 mt-20 relative">
            <h1 data-aos="fade-down" class="text-center sm:text-6xl text-5xl font-bold text-primary ">{title}</h1>
