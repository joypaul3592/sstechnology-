...
import team9 from '../../../assets/image/team/team9.jpg';
...
const Team = () => {
    ...
    const teamsData = [
        {
            id: 1,
            name: 'Aar rafi shahriar shad',
            designation: 'Founder & Md',
            text: 'Shahriar Shad is a visionary founder, known for strategic leadership and driving innovative ventures to success.',
            img: team9
        },
        {
            id: 2,
            ...
            text: 'Shahrear Alam Maruf is a skilled co-founder and developer known for delivering high-quality projects on time and within budget.',
            img: team1
        },
        {
            id: 3,
...

        {
            ...
            text: 'Sharforaz Rahman Swacha is a Project manager &  Backend developer, specializing in server-side logic and database management.',
            img: team8
        }
    ...
    return (
        <div>
            ...
            <div className="pt-32  pb-0 2xl:w-9/12 xl:w-10/12 w-full mx-auto z-[10] relative sm:flex grid grid-cols-2 gap-28  flex-wrap justify-center ">
                {teamsData?.map((team) => (
                        ...
                        <div className={`absolute sm:w-[22rem] w-[16rem]  transition-all ease-linear duration-200 z-[100] ${team?.id % 2 ? 'bottom-[14rem] sm:-left-36 left-0 ' : 'sm:bottom-24 bottom-[6rem] sm:-left-36 -left-[8.8rem] '}  ${isHover === team?.id ? 'visible  scale-100' : 'invisible  scale-0'}`}>
                            <div className="bg-gradient-to-r from-[#0f0f1148] via-[#0529f83b] to-[#0f0f1148] w-full rounded-md p-3 text-center relative border border-blue-700 bg-[#040412]">
                                ...
                                <svg className={`w-6 h-3 rotate-90 absolute -bottom-[13px] ${team?.id % 2 ? 'sm:left-[49%] left-[10%]' : 'sm:left-[49%] left-[75%]'} `} viewBox="0 0 100 100">
                                    <path d="M0 0 L100 50 L0 100 Z" fill="#3f3f6d48" className="z-[-1]" />
                                </svg>
                            </div>
                        </div>
                    </div>
